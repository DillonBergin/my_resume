...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    if(sheet_is_publicly_readable){
      ...
      options(gargle_oauth_cache = "C:/Users/newsd/AppData/Local/gargle/gargle/Cache")
    }
    ...
    cv$skills1        <- read_gsheet(sheet_id = "programming_languages")
    cv$skills2        <- read_gsheet(sheet_id = "human_languages")
    ...
    cv$skills       <- readr::read_csv(paste0(data_location, "human_languages.csv"), skip = 1)
...
print_skill_bars1 <- function(cv, out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
...
print_skill_bars2 <- function(cv, out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
